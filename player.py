...
class Player:
    def __init__(self):
        ...
        self.vel = 0  # velocity
        self.flap = False  # jump
        self.alive = True
        self.lifespan = 0

        # AI
        self.decision = None
        self.vision = [0.5, 1, 0.5]  # these values represent the position of player with respect to pipes
        self.inputs = 3
        self.fitness = 0
        self.brain = brain.Brain(self.inputs)
        self.brain.generate_net()

    # game related fucntion
    ...
    # Genetic algo related function
    def look(self):
        if config.pipes:
            # returns bwtn -1 and 1
            # idr line bana rahy hn center aur uper wali
